...
export default {
  ...
  initGateway(gatewayUrl, gatewayToken) {
    try {
      gatewayClient.configure(gatewayUrl, gatewayToken)
      gatewayClient.start()
      chatData.gatewayMode = true
      console.log("[Gateway] initialized with mode:", chatData.gatewayMode)
    } catch (e) {
      console.warn("[Gateway] init failed:", e)
    }
  },
