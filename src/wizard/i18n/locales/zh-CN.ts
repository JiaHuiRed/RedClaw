...
export const zh_CN = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "直接把密码存入 RedClaw 配置",
    ...
    remote: {
      ...
      plaintextPasswordHint: "直接把密码存入 RedClaw 配置",
      plaintextPasswordLabel: "现在输入密码",
      plaintextTokenHint: "直接把令牌存入 RedClaw 配置",
    ...
    security: {
      ...
      beta: "RedClaw 是个人项目，仍处于 beta 阶段，使用时请做好心理准备。",
      confirm: "我了解 RedClaw 默认面向个人单用户；共享/多用户场景需要额外加固。继续？",
      hardeningRequired: "如果你不熟悉安全加固和访问控制，请谨慎开放给他人使用。",
      learnMore: "了解更多",
      notMultitenant: "RedClaw 默认不具备多租户安全隔离。",
      personalAgent: "默认情况下，RedClaw 是个人专属 agent：单一可信操作者边界。",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) 运行：./occ talk:bot:install "RedClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "需要发送者/所有者号码，以便 RedClaw 将你加入允许列表。",
      ...
      separatePhoneLabel: "RedClaw 专用独立手机",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "这是 RedClaw 用来向 Chat 发送回复的 URL。",
    ...
    signal: {
      ...
      multipleEntries: "多个条目请用逗号分隔。",
      nextLinkDevice: '绑定设备：signal-cli link -n "RedClaw"',
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "将 Synology NAS Chat 连接到 RedClaw，并启用完整 agent 能力。",
    ...
    finalize: {
      ...
      dashboardCopyPaste: "在本机浏览器中复制/粘贴这个 URL 来控制 RedClaw。",
      dashboardLinkWithToken: "Dashboard 链接（含令牌）：{url}",
      dashboardOpened: "已在浏览器中打开。保留该标签页以控制 RedClaw。",
      ...
      optionalApps: "可选应用",
      outroDashboardLink: "初始化完成。使用上面的 dashboard 链接控制 RedClaw。",
      outroDashboardOpened: "初始化完成。Dashboard 已打开，保留该标签页即可控制 RedClaw。",
